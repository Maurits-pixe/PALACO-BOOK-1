...
No production threat is marked closed solely by a mock test. This draft introduces no API endpoint, database, login federation, active signer or deployment action. Server-side integration must reject a fabricated/replayed receipt even if a browser displays AUTHORIZED.
